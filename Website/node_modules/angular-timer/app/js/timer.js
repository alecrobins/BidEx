  ...
  .directive('timer', ['$compile', function ($compile) {
    return  {
      ...
      controller: ['$scope', '$element', '$attrs', '$timeout', function ($scope, $element, $attrs, $timeout) {
        ...
        $scope.countdown = $scope.custom.endTime && parseInt($scope.custom.endTime, 10) >= 0 ? parseInt($scope.custom.endTime, 10) : undefined;
        ...
        $scope.start = $element[0].start = function () {
          ...
          $scope.endTime = $scope.custom.endTime ? new Date($scope.custom.endTime) : null;
          if (!$scope.countdown) {
            $scope.countdown = $scope.custom.endTime && parseInt($scope.custom.endTime, 10) > 0 ? parseInt($scope.custom.endTime, 10) : undefined;
          }
          resetTimeout();
        ...
        if ($scope.custom.endTime) {
          $scope.millis = $scope.custom.endTime * 1000;
